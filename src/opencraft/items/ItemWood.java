...
public class ItemWood extends Item{
	...
	public void drawIcon(float x, float y, float z,float size) {
		...
		glBegin(GL_QUADS);
		ModelCube.drawModel(x, y, z,new float[] {0.7f,0,0.7f,0,0.7f,0,0.7f,0,0.7f,0,0.7f,0},1f,1f,1f,1f,1f,1f,1f,size);
		glEnd();
	...
	public void rightClickAction() {
		...
		try {
			...
			World.setBlock("BlockWood", (int)b.getX(),(int)b.getY(), (int)b.getZ());
